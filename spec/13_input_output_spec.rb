...
describe NumberGame do
  ...
  describe '#game_over?' do
    ...
    context 'when user guess is not correct' do
      subject(:game_complete) { described_class.new(1, '9') }

      # remove the 'x' before running this test
      it 'is not game over' do
        expect(game_complete.solution).not_to eq game_complete.guess
      end
    end
  end
  ...
  describe '#verify_input' do
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        expect(game.verify_input('91')).to eq(nil)
      end
    end
  end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      # remove the 'x' before running this test
      it 'outputs correct phrase' do
        above_four_phrase = "That was hard. It took you 5 guesses!\n"
        expect { game.final_message }.to output(above_four_phrase).to_stdout
      end
    end
  end
end
