...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous step i 16' do
      it 'returns 12' do
        result = game.subtract_four(16)
  ...
  describe '#subtract_random_number' do
    context 'when the previous step is 21 and the random number is 6' do
  ...
  describe '#play' do
    ...
    context 'when the random number is 89' do
      subject(:game) { described_class.new(89) }
